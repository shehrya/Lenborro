...
public class ApprovedLoanOffersListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.approved_loan_offers_list_activity);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ApprovedLoanOffersListActivity.this, ApprovedLoanOffersActivity.class);
        ...
        new FetchApprovedLoanOffersFromServer().execute("http://www.voltbuy.com/Lenborro/LoanOffers/ApprovedLoanOffers/ApprovedLoanOffers.txt");
    ...
    private class FetchApprovedLoanOffersFromServer extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... urls) {

            // params comes from the execute() call: params[0] is the url.
            try {
                return ApprovedLoanOffers(urls[0]);
            } catch (IOException e) {
                return "NotFound";
            }
        }
    ...
    private String ApprovedLoanOffers(String myurl) throws IOException, UnsupportedEncodingException {
        InputStream is = null;
    ...
    public void LogoutButtonClicked(View v)
    {
        ...
        Intent intent = new Intent(ApprovedLoanOffersListActivity.this , AlreadyLoggedInActivity.class);
        startActivity(intent);
        finish();
